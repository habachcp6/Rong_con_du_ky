...
| M5 | Firebase persistence | PASS (local/emulator) | Anonymous client/mirror, local fallback, UID rules, reconciliation ADR and unit contracts pass. Auth + Firestore Emulator rules suite passes 7/7; configured real-project/browser Auth smoke remains a release checkpoint. |
