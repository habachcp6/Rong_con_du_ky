...
| Technical video evidence   | PASS local 2026-08-03 | `npm run test:e2e:record` PASS; WebM 1,524,690 bytes dưới `test-results/playwright/**/video.webm`, bị Git ignore. Không thay thế video pitch.                                            |
