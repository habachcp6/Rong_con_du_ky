# Sources and asset attribution — Rồng Con Du Ký

This file is the canonical registry for the source IDs referenced by `content/*.json` and `public/assets/manifest.json`. Tourism facts are paraphrased; no third-party copy or photograph is bundled in the game.

## `source_dragon_bridge_01`

- **Kind:** tourism-fact
- **Publisher:** Da Nang Tourism Promotion Center / Danang Fantasticity
- **Title:** Dragon Bridge
- **URL:** https://danangfantasticity.com/cn/dragon-bridge
- **Accessed:** 2026-08-03
...
- **Supports:** Dragon Bridge spans the Han River, dragon-shaped design, 666 m length, 37.5 m width, and six traffic lanes.

## `source_my_khe_01`

- **Kind:** tourism-fact
- **Publisher:** Da Nang Tourism Promotion Center / Danang Fantasticity
- **Title:** Biển Mỹ Khê / My Khe Beach
- **URL:** https://danangfantasticity.com/en/bien-my-khe
- **Accessed:** 2026-08-03
- **License / use:** Facts paraphrased for an educational hackathon game; page text and images remain with the publisher and are not copied into this repository.
- **Supports:** My Khe is on Da Nang's eastern coast, is approximately 3–5 km from the city centre, and is described as having white sand, open space, and beach activity.

## `source_marble_mountains_01`

- **Kind:** tourism-fact
- **Publisher:** Da Nang Tourism Promotion Center / Danang Fantasticity
- **Title:** The Marble Mountains
- **URL:** https://danangfantasticity.com/en/travel-directory/the-marble-mountains
- **Accessed:** 2026-08-03
- **License / use:** Facts paraphrased for an educational hackathon game; page text and images remain with the publisher and are not copied into this repository.
- **Supports:** The complex's caves, pagodas, stone steps, six named peaks, and 2014 National Intangible Cultural Heritage recognition for Non Nuoc stone carving village.

## `source_son_tra_01`

- **Kind:** tourism-fact
- **Publisher:** Da Nang Tourism Promotion Center / Danang Fantasticity
- **Title:** The Son Tra Peninsula
- **URL:** https://danangfantasticity.com/en/heritage-landscape/the-son-tra-peninsula
- **Accessed:** 2026-08-03
- **License / use:** Facts paraphrased for an educational hackathon game; page text and images remain with the publisher and are not copied into this repository.
- **Supports:** Son Tra's northeastern Da Nang location, diverse protected ecosystem, red-shanked douc habitat, safe observation guidance, and the city's “green lung” description.

## `source_son_tra_conservation_01`

- **Kind:** tourism-fact
- **Publisher:** GreenViet Biodiversity Conservation Centre
- **Title:** GreenViet homepage and red-shanked douc conservation programme
- **URL:** https://greenviet.org/en/homepage/
- **Accessed:** 2026-08-03
...
- **URL:** https://visitdanang.travel/vi/banh-xeo-ba-duong
- **Accessed:** 2026-08-03
...
- **Supports:** The curated card's venue name, bánh xèo category, and Hoàng Diệu address reference.

## `source_food_hoangs_kitchen_01`

- **Kind:** curated-place
- **Publisher:** Hoang's Kitchen Da Nang
- **Title:** Hoang's Kitchen Da Nang
- **URL:** https://hoangskitchendanang.com/
- **Accessed:** 2026-08-03
- **License / use:** Name, address, and vegetarian/vegan offering are referenced from the venue's own site. No rating, review, image, opening hour, or menu price is copied.
- **Supports:** The curated card's venue name, Hà Bổng address, and vegetarian-friendly description.

## `source_food_mi_quang_ba_mua_01`

- **Kind:** curated-place
- **Publisher:** Visit Da Nang travel directory
- **Title:** Mi Quang Ba Mua
- **URL:** https://visitdanang.travel/en/mi-quang-ba-mua-2186
- **Accessed:** 2026-08-03
- **License / use:** Name and address are used as a short, attributed directory reference. No rating, review, image, opening hour, or menu price is copied.
- **Supports:** The curated card's venue name, mi quang category, and 40 Ngũ Hành Sơn address reference.

## `source_food_maha_vegetariano_01`

- **Kind:** curated-place
- **Publisher:** Maha Vegetariano
- **Title:** Maha Vegetariano — Vegetarian Restaurant in Da Nang
- **URL:** https://mahavn.com/
- **Accessed:** 2026-08-03
...
- **Publisher:** Rồng Con Du Ký Hackathon Team
- **Title:** Starter-track curated-card policy
- **URL:** local://content/curated-places.json
- **Accessed:** 2026-08-03
- **License / use:** Original app metadata. `budget` and `moderate` are editorial grouping labels for local filtering, not current price quotes, and must not be rendered as a factual price.
- **Supports:** App-authored descriptions, landmark association, dietary filter label, and non-monetary price-tier grouping for Starter cards.

## `asset_placeholder_original_01`

- **Kind:** asset-attribution
- **Author:** Rồng Con Du Ký Hackathon Team
- **Title:** M1 geometric pixel-art development placeholders
- **URL:** local://public/assets/manifest.json
- **Accessed:** 2026-08-03
