...
Your working directory is D:\Hackthon-GG2026\.agents\reviewer_m1_2. Create this directory first for metadata.
...
2. Inspect content changes made by worker_m1:
   ...
   - `content/curated-places.json` (12 food cards covering all 10 landmarks, no restricted Places fields)
...
4. Document your review findings and explicitly state your verdict: APPROVE or REQUEST_CHANGES in `D:\Hackthon-GG2026\.agents\reviewer_m1_2\handoff.md`. Send a summary message to parent.
</USER_REQUEST>
